        ...
        if ($dir == "/") {
            if (File::exists(base_path() . "/" . $this->file_location . $new_name)) {
                ...
                if (File::isDirectory(base_path() . "/" . $this->file_location . $file_to_rename)) {
                    File::move(
                        base_path() . "/" . $this->file_location . $file_to_rename,
                    ...
                    if (Session::get('lfm_type') == "Images") {
                        // rename thumbnail
                        File::move(
                            base_path() . "/" . $this->file_location . "thumbs/" . $file_to_rename,
            ...
            if (File::exists(base_path() . "/" . $this->file_location . $dir . "/" . $new_name)) {
                ...
                if (File::isDirectory(base_path() . "/" . $this->file_location . $dir . "/" . $file_to_rename)) {
                    File::move(
                        base_path() . "/" . $this->file_location . $dir . "/" . $file_to_rename,
                    ...
                    if (Session::get('lfm_type') == "Images") {
                        File::move(
                            base_path() . "/" . $this->file_location . $dir . "/thumbs/" . $file_to_rename,
